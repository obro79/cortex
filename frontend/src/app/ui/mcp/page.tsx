...
export default function McpSetupPage() {
  return <AppShell><main className="mx-auto max-w-5xl p-6">
    ...
    <div className="mt-6 grid gap-4 lg:grid-cols-2">
      ...
      <section className="cortex-panel p-4"><h2 className="text-sm font-semibold">Configuration availability</h2><p className="mt-4 text-sm leading-6 text-muted-foreground">No supported local MCP executable or client configuration command is published yet. This UI intentionally does not prescribe a command, arguments, or environment variables.</p><p className="mt-3 text-xs leading-5 text-muted-foreground">Connection details, secrets, workspace identifiers, and access tokens must be issued through an authenticated setup flow before they can be shown here.</p></section>
