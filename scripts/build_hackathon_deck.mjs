...
const slides = [
  ...
  ["From source shape to evidence", ["Provider-shaped fixtures → normalization → context chunks → retrieval → inspectable answer", "Target architecture shown; no live provider API, OAuth, customer workspace, or production index."]],
