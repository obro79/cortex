...
- [ADR-001: Python FastAPI Backend](adrs/001-python-fastapi-backend.md)
- [ADR-002: Kafka Event Backbone](adrs/002-kafka-event-backbone.md)
- [ADR-003: Hosted-First Data Boundary](adrs/003-hosted-first-data-boundary.md)
- [ADR-004: Postgres Source Of Truth](adrs/004-postgres-source-of-truth.md)
- [ADR-005: Hybrid Retrieval Stack](adrs/005-hybrid-retrieval-stack.md)
- [ADR-006: Provider-Neutral Embeddings](adrs/006-provider-neutral-embeddings.md)
- [ADR-007: Source-Aware Chunking](adrs/007-source-aware-chunking.md)
- [ADR-008: Deterministic-First Linking](adrs/008-deterministic-first-linking.md)
- [ADR-009: Source Allowlist Permissions V1](adrs/009-source-allowlist-permissions-v1.md)
- [ADR-010: Local MCP Proxy With Device Login](adrs/010-local-mcp-proxy-device-login.md)
- [ADR-011: Slack Files And Diagrams Via Metadata And OCR](adrs/011-slack-files-diagrams-ocr.md)
- [ADR-012: Secrets And Token Management](adrs/012-secrets-token-management.md)
- [ADR-013: Webhook Security And Idempotency](adrs/013-webhook-security-idempotency.md)
- [ADR-014: Retention And Deletion](adrs/014-retention-deletion.md)
- [ADR-015: Rate Limits Backpressure And Repair](adrs/015-rate-limits-backpressure-repair.md)
- [ADR-016: Retrieval Evals And Model Gateway](adrs/016-retrieval-evals-model-gateway.md)
- [ADR-017: Dev Workbench And Deterministic Pipeline Fixtures](adrs/017-dev-workbench-deterministic-fixtures.md)
- [ADR-018: Grafana Cloud Lean Observability](adrs/018-grafana-cloud-lean-observability.md)
- [ADR-019: Containerized Services Kubernetes Compatible](adrs/019-containerized-services-kubernetes-compatible.md)
- [ADR-020: Layered Platform Components](adrs/020-layered-platform-components.md)
- [ADR-021: Distributed Coordination Without Custom Leader](adrs/021-distributed-coordination-without-custom-leader.md)
